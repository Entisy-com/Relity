...
const Schema: z.ZodType<Prisma.CategoryUncheckedCreateNestedManyWithoutServerInput> =
  z
    .object({
      create: z
        .union([
...
export const CategoryUncheckedCreateNestedManyWithoutServerInputObjectSchema =
  Schema;
