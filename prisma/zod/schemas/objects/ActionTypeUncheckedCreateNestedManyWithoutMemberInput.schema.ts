...
const Schema: z.ZodType<Prisma.ActionTypeUncheckedCreateNestedManyWithoutMemberInput> =
  z
    .object({
      create: z
        .union([
...
export const ActionTypeUncheckedCreateNestedManyWithoutMemberInputObjectSchema =
  Schema;
