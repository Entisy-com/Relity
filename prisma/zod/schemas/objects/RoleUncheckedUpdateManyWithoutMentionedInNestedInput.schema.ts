...
const Schema: z.ZodType<Prisma.RoleUncheckedUpdateManyWithoutMentionedInNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleUncheckedUpdateManyWithoutMentionedInNestedInputObjectSchema =
  Schema;
