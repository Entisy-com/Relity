...
const Schema: z.ZodType<Prisma.ServerUncheckedUpdateWithoutVoicechannelInput> =
  z
    .object({
      id: z
        .union([
...
export const ServerUncheckedUpdateWithoutVoicechannelInputObjectSchema = Schema;
