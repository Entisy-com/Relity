...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateWithoutMentionedMembersInput> =
  z
    .object({
      id: z
        .union([
...
export const MessageUncheckedUpdateWithoutMentionedMembersInputObjectSchema =
  Schema;
