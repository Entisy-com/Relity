...
const Schema: z.ZodType<Prisma.TextChannelUncheckedUpdateManyWithoutTextchannelInput> =
  z
    .object({
      id: z
        .union([
...
export const TextChannelUncheckedUpdateManyWithoutTextchannelInputObjectSchema =
  Schema;
