...
const Schema: z.ZodType<Prisma.MemberUncheckedCreateWithoutActionTypeInput> = z
  .object({
...
export const MemberUncheckedCreateWithoutActionTypeInputObjectSchema = Schema;
