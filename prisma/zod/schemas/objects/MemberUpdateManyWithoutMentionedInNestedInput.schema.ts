...
const Schema: z.ZodType<Prisma.MemberUpdateManyWithoutMentionedInNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MemberUpdateManyWithoutMentionedInNestedInputObjectSchema = Schema;
