...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutMentionedRolesNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedUpdateManyWithoutMentionedRolesNestedInputObjectSchema =
  Schema;
