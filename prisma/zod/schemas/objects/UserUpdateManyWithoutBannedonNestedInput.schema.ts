...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutBannedonNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserUpsertWithWhereUniqueWithoutBannedonInputObjectSchema),
        z
          .lazy(() => UserUpsertWithWhereUniqueWithoutBannedonInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => UserUpdateWithWhereUniqueWithoutBannedonInputObjectSchema),
        z
          .lazy(() => UserUpdateWithWhereUniqueWithoutBannedonInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserUpdateManyWithoutBannedonNestedInputObjectSchema = Schema;
