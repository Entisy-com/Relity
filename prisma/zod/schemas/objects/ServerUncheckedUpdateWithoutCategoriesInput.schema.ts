...
const Schema: z.ZodType<Prisma.ServerUncheckedUpdateWithoutCategoriesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ServerUncheckedUpdateWithoutCategoriesInputObjectSchema = Schema;
