...
const Schema: z.ZodType<Prisma.ServerUncheckedUpdateOneWithoutOwnerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      upsert: z
        .lazy(() => ServerUpsertWithoutOwnerInputObjectSchema)
        .optional(),
...
export const ServerUncheckedUpdateOneWithoutOwnerNestedInputObjectSchema =
  Schema;
