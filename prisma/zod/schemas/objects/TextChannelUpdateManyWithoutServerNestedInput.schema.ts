...
const Schema: z.ZodType<Prisma.TextChannelUpdateManyWithoutServerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TextChannelUpdateManyWithoutServerNestedInputObjectSchema = Schema;
