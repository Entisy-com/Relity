...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutServerUserPositionInput> =
  z
    .object({
      id: z
        .union([
      ...
      adminuser: z
        .lazy(
          () => AdminUserUncheckedUpdateOneWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      sessions: z
        .lazy(
      ...
      friendsWith: z
        .lazy(
          () => UserUncheckedUpdateManyWithoutFriendsNestedInputObjectSchema,
        )
        .optional(),
      member: z
...
export const UserUncheckedUpdateWithoutServerUserPositionInputObjectSchema =
  Schema;
