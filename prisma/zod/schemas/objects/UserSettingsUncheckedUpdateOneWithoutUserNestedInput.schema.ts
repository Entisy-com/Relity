...
const Schema: z.ZodType<Prisma.UserSettingsUncheckedUpdateOneWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserSettingsUncheckedUpdateOneWithoutUserNestedInputObjectSchema =
  Schema;
