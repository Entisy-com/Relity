...
const Schema: z.ZodType<Prisma.ActionTypeUncheckedUpdateManyWithoutActionlogNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ActionTypeUncheckedUpdateManyWithoutActionlogNestedInputObjectSchema =
  Schema;
