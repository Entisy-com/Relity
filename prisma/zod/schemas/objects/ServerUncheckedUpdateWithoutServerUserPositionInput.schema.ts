...
const Schema: z.ZodType<Prisma.ServerUncheckedUpdateWithoutServerUserPositionInput> =
  z
    .object({
      id: z
        .union([
      ...
      members: z
        .lazy(
          () => MemberUncheckedUpdateManyWithoutServerNestedInputObjectSchema,
        )
        .optional(),
      bannedUser: z
        .lazy(
          () => UserUncheckedUpdateManyWithoutBannedonNestedInputObjectSchema,
        )
        .optional(),
      actionLog: z
        .lazy(
...
export const ServerUncheckedUpdateWithoutServerUserPositionInputObjectSchema =
  Schema;
