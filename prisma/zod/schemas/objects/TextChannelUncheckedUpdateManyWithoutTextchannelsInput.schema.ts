...
const Schema: z.ZodType<Prisma.TextChannelUncheckedUpdateManyWithoutTextchannelsInput> =
  z
    .object({
      id: z
        .union([
...
export const TextChannelUncheckedUpdateManyWithoutTextchannelsInputObjectSchema =
  Schema;
