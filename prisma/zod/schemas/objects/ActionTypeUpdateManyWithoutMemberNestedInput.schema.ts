...
const Schema: z.ZodType<Prisma.ActionTypeUpdateManyWithoutMemberNestedInput> = z
  .object({
    create: z
      .union([
...
export const ActionTypeUpdateManyWithoutMemberNestedInputObjectSchema = Schema;
