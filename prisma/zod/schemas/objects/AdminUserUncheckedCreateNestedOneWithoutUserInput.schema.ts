...
const Schema: z.ZodType<Prisma.AdminUserUncheckedCreateNestedOneWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const AdminUserUncheckedCreateNestedOneWithoutUserInputObjectSchema =
  Schema;
