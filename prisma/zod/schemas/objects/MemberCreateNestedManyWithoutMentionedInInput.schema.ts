...
const Schema: z.ZodType<Prisma.MemberCreateNestedManyWithoutMentionedInInput> =
  z
    .object({
      create: z
        .union([
...
export const MemberCreateNestedManyWithoutMentionedInInputObjectSchema = Schema;
