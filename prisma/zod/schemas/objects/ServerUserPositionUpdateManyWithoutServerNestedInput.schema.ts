...
const Schema: z.ZodType<Prisma.ServerUserPositionUpdateManyWithoutServerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerUserPositionUpdateManyWithoutServerNestedInputObjectSchema =
  Schema;
