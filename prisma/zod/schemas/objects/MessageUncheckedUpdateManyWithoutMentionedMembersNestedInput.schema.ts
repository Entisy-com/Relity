...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutMentionedMembersNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedUpdateManyWithoutMentionedMembersNestedInputObjectSchema =
  Schema;
