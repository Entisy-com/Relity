...
const Schema: z.ZodType<Prisma.ServerSettingsUncheckedCreateNestedOneWithoutServerInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerSettingsUncheckedCreateNestedOneWithoutServerInputObjectSchema =
  Schema;
