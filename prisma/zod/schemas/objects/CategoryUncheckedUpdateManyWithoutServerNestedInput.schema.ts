...
const Schema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutServerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => CategoryUpdateManyWithWhereWithoutServerInputObjectSchema,
          ),
          z
            .lazy(
              () => CategoryUpdateManyWithWhereWithoutServerInputObjectSchema,
...
export const CategoryUncheckedUpdateManyWithoutServerNestedInputObjectSchema =
  Schema;
