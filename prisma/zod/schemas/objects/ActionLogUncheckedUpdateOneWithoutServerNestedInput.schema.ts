...
const Schema: z.ZodType<Prisma.ActionLogUncheckedUpdateOneWithoutServerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ActionLogUncheckedUpdateOneWithoutServerNestedInputObjectSchema =
  Schema;
