...
const Schema: z.ZodType<Prisma.MemberUncheckedCreateNestedManyWithoutVoiceChannelInput> =
  z
    .object({
      create: z
        .union([
...
export const MemberUncheckedCreateNestedManyWithoutVoiceChannelInputObjectSchema =
  Schema;
