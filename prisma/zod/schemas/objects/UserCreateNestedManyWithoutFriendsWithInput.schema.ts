...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutFriendsWithInput> = z
  .object({
    create: z
      .union([
...
export const UserCreateNestedManyWithoutFriendsWithInputObjectSchema = Schema;
