...
const Schema: z.ZodType<Prisma.MessageUncheckedCreateNestedManyWithoutAuthorInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedCreateNestedManyWithoutAuthorInputObjectSchema =
  Schema;
