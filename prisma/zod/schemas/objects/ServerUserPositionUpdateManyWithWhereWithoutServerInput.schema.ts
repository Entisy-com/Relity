...
const Schema: z.ZodType<Prisma.ServerUserPositionUpdateManyWithWhereWithoutServerInput> =
  z
    .object({
...
export const ServerUserPositionUpdateManyWithWhereWithoutServerInputObjectSchema =
  Schema;
