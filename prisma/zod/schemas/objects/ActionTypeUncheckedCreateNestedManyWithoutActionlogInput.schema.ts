...
const Schema: z.ZodType<Prisma.ActionTypeUncheckedCreateNestedManyWithoutActionlogInput> =
  z
    .object({
      create: z
        .union([
...
export const ActionTypeUncheckedCreateNestedManyWithoutActionlogInputObjectSchema =
  Schema;
