...
const Schema: z.ZodType<Prisma.VoiceChannelUncheckedUpdateManyWithoutServerNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceChannelUncheckedUpdateManyWithoutServerNestedInputObjectSchema =
  Schema;
