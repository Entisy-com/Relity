...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithWhereWithoutMentionedRolesInput> =
  z
    .object({
...
export const MessageUpdateManyWithWhereWithoutMentionedRolesInputObjectSchema =
  Schema;
