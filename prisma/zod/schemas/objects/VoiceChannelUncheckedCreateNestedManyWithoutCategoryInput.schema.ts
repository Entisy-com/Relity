...
const Schema: z.ZodType<Prisma.VoiceChannelUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceChannelUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
