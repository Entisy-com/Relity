...
const Schema: z.ZodType<Prisma.ServerUserPositionUncheckedCreateNestedManyWithoutServerInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerUserPositionUncheckedCreateNestedManyWithoutServerInputObjectSchema =
  Schema;
