...
const Schema: z.ZodType<Prisma.MessageCreateNestedManyWithoutMentionedMembersInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageCreateNestedManyWithoutMentionedMembersInputObjectSchema =
  Schema;
