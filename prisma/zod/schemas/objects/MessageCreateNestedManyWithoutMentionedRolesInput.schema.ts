...
const Schema: z.ZodType<Prisma.MessageCreateNestedManyWithoutMentionedRolesInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageCreateNestedManyWithoutMentionedRolesInputObjectSchema =
  Schema;
