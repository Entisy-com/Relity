...
const Schema: z.ZodType<Prisma.ActionTypeUncheckedUpdateWithoutMemberInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ActionTypeUncheckedUpdateWithoutMemberInputObjectSchema = Schema;
