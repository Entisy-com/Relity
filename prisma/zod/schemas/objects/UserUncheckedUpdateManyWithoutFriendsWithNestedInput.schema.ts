...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutFriendsWithNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedUpdateManyWithoutFriendsWithNestedInputObjectSchema =
  Schema;
