...
const Schema: z.ZodType<Prisma.MemberUncheckedUpdateWithoutVoiceChannelInput> =
  z
    .object({
      id: z
        .union([
      ...
      roles: z
        .lazy(
          () => RoleUncheckedUpdateManyWithoutMembersNestedInputObjectSchema,
        )
        .optional(),
      ownerOf: z
...
export const MemberUncheckedUpdateWithoutVoiceChannelInputObjectSchema = Schema;
