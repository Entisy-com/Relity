...
const Schema: z.ZodType<Prisma.MemberUncheckedUpdateWithoutMentionedInInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const MemberUncheckedUpdateWithoutMentionedInInputObjectSchema = Schema;
