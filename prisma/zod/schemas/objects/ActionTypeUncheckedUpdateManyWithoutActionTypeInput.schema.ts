...
const Schema: z.ZodType<Prisma.ActionTypeUncheckedUpdateManyWithoutActionTypeInput> =
  z
    .object({
      id: z
        .union([
...
export const ActionTypeUncheckedUpdateManyWithoutActionTypeInputObjectSchema =
  Schema;
