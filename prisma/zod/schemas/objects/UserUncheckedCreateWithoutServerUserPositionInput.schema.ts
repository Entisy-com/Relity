...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutServerUserPositionInput> =
  z
    .object({
      ...
      adminuser: z
        .lazy(
          () => AdminUserUncheckedCreateNestedOneWithoutUserInputObjectSchema,
        )
        .optional(),
      sessions: z
        .lazy(
      ...
      friendsWith: z
        .lazy(
          () => UserUncheckedCreateNestedManyWithoutFriendsInputObjectSchema,
        )
        .optional(),
      member: z
...
export const UserUncheckedCreateWithoutServerUserPositionInputObjectSchema =
  Schema;
