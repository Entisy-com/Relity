...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithWhereWithoutTextChannelInput> =
  z
    .object({
...
export const MessageUpdateManyWithWhereWithoutTextChannelInputObjectSchema =
  Schema;
