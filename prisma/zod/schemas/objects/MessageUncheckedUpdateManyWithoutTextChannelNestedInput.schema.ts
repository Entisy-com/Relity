...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutTextChannelNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const MessageUncheckedUpdateManyWithoutTextChannelNestedInputObjectSchema =
  Schema;
