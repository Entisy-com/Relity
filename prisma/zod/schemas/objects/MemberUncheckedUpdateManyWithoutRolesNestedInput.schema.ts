...
const Schema: z.ZodType<Prisma.MemberUncheckedUpdateManyWithoutRolesNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => MemberUpsertWithWhereUniqueWithoutRolesInputObjectSchema,
          ),
          z
            .lazy(
              () => MemberUpsertWithWhereUniqueWithoutRolesInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => MemberUpdateWithWhereUniqueWithoutRolesInputObjectSchema,
          ),
          z
            .lazy(
              () => MemberUpdateWithWhereUniqueWithoutRolesInputObjectSchema,
...
export const MemberUncheckedUpdateManyWithoutRolesNestedInputObjectSchema =
  Schema;
