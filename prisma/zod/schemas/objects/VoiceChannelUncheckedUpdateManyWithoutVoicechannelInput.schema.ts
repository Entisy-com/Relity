...
const Schema: z.ZodType<Prisma.VoiceChannelUncheckedUpdateManyWithoutVoicechannelInput> =
  z
    .object({
      id: z
        .union([
...
export const VoiceChannelUncheckedUpdateManyWithoutVoicechannelInputObjectSchema =
  Schema;
