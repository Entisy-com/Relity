...
const Schema: z.ZodType<Prisma.ServerUncheckedUpdateWithoutBannedUserInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const ServerUncheckedUpdateWithoutBannedUserInputObjectSchema = Schema;
