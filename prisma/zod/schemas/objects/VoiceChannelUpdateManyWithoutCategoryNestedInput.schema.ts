...
const Schema: z.ZodType<Prisma.VoiceChannelUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const VoiceChannelUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
