...
const Schema: z.ZodType<Prisma.MemberUncheckedCreateNestedManyWithoutRolesInput> =
  z
    .object({
      create: z
        .union([
...
export const MemberUncheckedCreateNestedManyWithoutRolesInputObjectSchema =
  Schema;
