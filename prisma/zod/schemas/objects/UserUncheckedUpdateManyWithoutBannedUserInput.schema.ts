...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutBannedUserInput> =
  z
    .object({
      id: z
        .union([
...
export const UserUncheckedUpdateManyWithoutBannedUserInputObjectSchema = Schema;
