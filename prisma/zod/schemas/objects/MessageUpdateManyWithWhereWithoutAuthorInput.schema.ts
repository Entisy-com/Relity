...
const Schema: z.ZodType<Prisma.MessageUpdateManyWithWhereWithoutAuthorInput> = z
  .object({
...
export const MessageUpdateManyWithWhereWithoutAuthorInputObjectSchema = Schema;
