...
const Schema: z.ZodType<Prisma.TextChannelUncheckedUpdateWithoutServerInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const TextChannelUncheckedUpdateWithoutServerInputObjectSchema = Schema;
