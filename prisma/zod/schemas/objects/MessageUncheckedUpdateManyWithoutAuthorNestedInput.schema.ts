...
const Schema: z.ZodType<Prisma.MessageUncheckedUpdateManyWithoutAuthorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => MessageUpdateManyWithWhereWithoutAuthorInputObjectSchema,
          ),
          z
            .lazy(
              () => MessageUpdateManyWithWhereWithoutAuthorInputObjectSchema,
...
export const MessageUncheckedUpdateManyWithoutAuthorNestedInputObjectSchema =
  Schema;
