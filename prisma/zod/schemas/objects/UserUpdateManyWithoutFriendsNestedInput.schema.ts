...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutFriendsNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => UserUpsertWithWhereUniqueWithoutFriendsInputObjectSchema),
        z
          .lazy(() => UserUpsertWithWhereUniqueWithoutFriendsInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => UserUpdateWithWhereUniqueWithoutFriendsInputObjectSchema),
        z
          .lazy(() => UserUpdateWithWhereUniqueWithoutFriendsInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const UserUpdateManyWithoutFriendsNestedInputObjectSchema = Schema;
