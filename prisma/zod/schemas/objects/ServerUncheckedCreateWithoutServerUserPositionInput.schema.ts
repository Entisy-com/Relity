...
const Schema: z.ZodType<Prisma.ServerUncheckedCreateWithoutServerUserPositionInput> =
  z
    .object({
...
export const ServerUncheckedCreateWithoutServerUserPositionInputObjectSchema =
  Schema;
