...
const Schema: z.ZodType<Prisma.ServerUserPositionUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerUserPositionUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
