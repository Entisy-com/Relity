...
const Schema: z.ZodType<Prisma.RoleCreateNestedManyWithoutMentionedInInput> = z
  .object({
    create: z
      .union([
...
export const RoleCreateNestedManyWithoutMentionedInInputObjectSchema = Schema;
