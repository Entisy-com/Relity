...
const Schema: z.ZodType<Prisma.ServerCreateNestedManyWithoutBannedUserInput> = z
  .object({
    create: z
      .union([
...
export const ServerCreateNestedManyWithoutBannedUserInputObjectSchema = Schema;
