...
const Schema: z.ZodType<Prisma.UserUpdateWithoutServerUserPositionInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    bannedon: z
      ...
      .optional(),
    friends: z
      .lazy(() => UserUpdateManyWithoutFriendsWithNestedInputObjectSchema)
      .optional(),
    friendsWith: z
...
export const UserUpdateWithoutServerUserPositionInputObjectSchema = Schema;
