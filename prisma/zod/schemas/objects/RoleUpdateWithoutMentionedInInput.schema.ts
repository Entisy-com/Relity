...
import { MemberUpdateManyWithoutRolesNestedInputObjectSchema } from './MemberUpdateManyWithoutRolesNestedInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.RoleUpdateWithoutMentionedInInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    server: z
      ...
      .optional(),
    members: z
      .lazy(() => MemberUpdateManyWithoutRolesNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const RoleUpdateWithoutMentionedInInputObjectSchema = Schema;
