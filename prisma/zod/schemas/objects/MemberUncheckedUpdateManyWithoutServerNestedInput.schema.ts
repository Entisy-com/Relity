...
const Schema: z.ZodType<Prisma.MemberUncheckedUpdateManyWithoutServerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => MemberUpsertWithWhereUniqueWithoutServerInputObjectSchema,
          ),
          z
            .lazy(
              () => MemberUpsertWithWhereUniqueWithoutServerInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => MemberUpdateWithWhereUniqueWithoutServerInputObjectSchema,
          ),
          z
            .lazy(
              () => MemberUpdateWithWhereUniqueWithoutServerInputObjectSchema,
...
export const MemberUncheckedUpdateManyWithoutServerNestedInputObjectSchema =
  Schema;
