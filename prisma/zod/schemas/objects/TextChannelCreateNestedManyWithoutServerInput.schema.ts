...
const Schema: z.ZodType<Prisma.TextChannelCreateNestedManyWithoutServerInput> =
  z
    .object({
      create: z
        .union([
...
export const TextChannelCreateNestedManyWithoutServerInputObjectSchema = Schema;
