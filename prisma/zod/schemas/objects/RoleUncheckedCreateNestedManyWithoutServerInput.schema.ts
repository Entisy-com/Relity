...
const Schema: z.ZodType<Prisma.RoleUncheckedCreateNestedManyWithoutServerInput> =
  z
    .object({
      create: z
        .union([
          ...
          z
            .lazy(() => RoleUncheckedCreateWithoutServerInputObjectSchema)
            .array(),
        ])
        .optional(),
      connectOrCreate: z
        .union([
          ...
          z
            .lazy(() => RoleCreateOrConnectWithoutServerInputObjectSchema)
            .array(),
        ])
        .optional(),
      createMany: z
...
export const RoleUncheckedCreateNestedManyWithoutServerInputObjectSchema =
  Schema;
