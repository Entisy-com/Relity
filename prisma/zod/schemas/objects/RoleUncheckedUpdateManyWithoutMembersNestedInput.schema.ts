...
const Schema: z.ZodType<Prisma.RoleUncheckedUpdateManyWithoutMembersNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => RoleUpsertWithWhereUniqueWithoutMembersInputObjectSchema,
          ),
          z
            .lazy(
              () => RoleUpsertWithWhereUniqueWithoutMembersInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => RoleUpdateWithWhereUniqueWithoutMembersInputObjectSchema,
          ),
          z
            .lazy(
              () => RoleUpdateWithWhereUniqueWithoutMembersInputObjectSchema,
...
export const RoleUncheckedUpdateManyWithoutMembersNestedInputObjectSchema =
  Schema;
