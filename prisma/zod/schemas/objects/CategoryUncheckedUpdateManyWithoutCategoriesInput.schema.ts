...
const Schema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutCategoriesInput> =
  z
    .object({
      id: z
        .union([
...
export const CategoryUncheckedUpdateManyWithoutCategoriesInputObjectSchema =
  Schema;
