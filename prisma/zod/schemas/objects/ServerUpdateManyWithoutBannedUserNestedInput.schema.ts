...
const Schema: z.ZodType<Prisma.ServerUpdateManyWithoutBannedUserNestedInput> = z
  .object({
    create: z
      .union([
...
export const ServerUpdateManyWithoutBannedUserNestedInputObjectSchema = Schema;
