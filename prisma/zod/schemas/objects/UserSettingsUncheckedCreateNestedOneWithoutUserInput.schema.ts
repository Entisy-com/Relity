...
const Schema: z.ZodType<Prisma.UserSettingsUncheckedCreateNestedOneWithoutUserInput> =
  z
    .object({
      create: z
        .union([
      ...
      connectOrCreate: z
        ...
        .optional(),
      connect: z
        .lazy(() => UserSettingsWhereUniqueInputObjectSchema)
        .optional(),
    })
    .strict();

export const UserSettingsUncheckedCreateNestedOneWithoutUserInputObjectSchema =
  Schema;
