...
const Schema: z.ZodType<Prisma.MemberUncheckedCreateWithoutVoiceChannelInput> =
  z
    .object({
      ...
      roles: z
        .lazy(
          () => RoleUncheckedCreateNestedManyWithoutMembersInputObjectSchema,
        )
        .optional(),
      ownerOf: z
...
export const MemberUncheckedCreateWithoutVoiceChannelInputObjectSchema = Schema;
