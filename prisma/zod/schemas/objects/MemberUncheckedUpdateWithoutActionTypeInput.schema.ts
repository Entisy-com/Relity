...
const Schema: z.ZodType<Prisma.MemberUncheckedUpdateWithoutActionTypeInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const MemberUncheckedUpdateWithoutActionTypeInputObjectSchema = Schema;
