...
const Schema: z.ZodType<Prisma.ServerUserPositionCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const ServerUserPositionCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
